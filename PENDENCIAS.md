...
- [ ] **Política de privacidade:** o advogado precisa revisar e aprovar a minuta e **definir o e-mail para assuntos de privacidade** (`PRIVACY.email` em `src/lib/content.ts`, hoje `[… A CONFIRMAR]`); depois remover a frase "Minuta em revisão" (some com `flags.conceptNotice`).
