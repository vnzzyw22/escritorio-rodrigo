...
export function Contact() {
  ...
  return (
    ...
    >
      <div className="page-x grid-12 gap-y-16">
        <div className="col-span-12 lg:col-span-7">
          ...
          <Reveal delay={0.1}>
            <p className="text-lead mt-10 max-w-[30rem] text-paper/85">{CONTACT.intro}</p>
            <ContactForm />
          </Reveal>
        </div>
        ...
        >
          ...
          <Frame slot="contact" sizes="(min-width: 1024px) 30vw, 100vw" range={5} tone="dark" />
        </aside>
      </div>
    </section>
  );
